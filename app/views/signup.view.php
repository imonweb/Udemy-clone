                ...
                <div class="card-body">
                  ...
                  <form method="post" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('firstname'); ?>" type="text" name="firstname" class="<?= !empty($errors['firstname']) ? 'border-danger' : ''; ?> form-control" id="yourName" required1>
                    ...
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('lastname'); ?>" type="text" name="lastname" class="<?= !empty($errors['lastname']) ? 'border-danger' : ''; ?> form-control" id="yourName" >
                    ...
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('password'); ?>" type="password" name="password" class="form-control <?= !empty($errors['password']) ? 'border-danger' : ''; ?>" id="yourPassword" >
